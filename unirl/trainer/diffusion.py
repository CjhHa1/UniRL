...
class DiffusionTrainer(BaseTrainer):
    ...
    def _build_train_side(
        ...
        *,
        ...
        # Inject the backend sibling for EMA algorithms (DiffusionNFT's shadow) AND for
        # algorithms that reach the trainable model directly — FlowGRPO / FlowDPPO disable
        # its LoRA adapter to forward the reference policy for the ``beta`` KL term.
