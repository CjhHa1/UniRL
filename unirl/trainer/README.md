...
| `AsyncARTrainer` | FIFO AR generation batch → one `TrainStack` | Separate train/rollout slabs with resident generation, optimizer-update policy-lag admission, and quiescence before weight sync, eval, or checkpoint. |
